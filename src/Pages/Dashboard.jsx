        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-800">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex cursor-pointer group relative">
              <Link
                to="/profile"
                className="w-10 h-10 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg"
              >
          ...
          <div className="flex justify-between items-center">
            <div className="relative">
              ...
              {isDeviceDropdownOpen && (
                <div className="absolute z-10 mt-2 w-56 bg-gray-800 rounded-lg shadow-lg border border-gray-700 overflow-hidden">
                  <div className="py-1">
                    {devices.map((device) => (
                      <button
                        key={device.id}
            ...
            <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-lg">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-white text-xl font-semibold">Humidity</h2>
                </div>
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-lg overflow-hidden">
              <div className="p-5 border-b border-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-white font-semibold">Air Quality</h2>
                </div>
              </div>
              <div
                className={`p-6 ${airQualityColor} flex flex-col items-center justify-center h-48`}
              >
                {airQuality === "Good" ? (
                ...
                <span className="text-2xl font-bold">{airQuality}</span>
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-lg overflow-hidden">
              <div className="p-5 border-b border-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-white font-semibold">TVOC Level</h2>
                </div>
              </div>
              <div
                className={`p-6 ${tvocColor} flex flex-col items-center justify-center h-48`}
              >
                <span className="text-4xl font-bold">{tvocLevel}</span>
                <span className="text-lg mt-1">ppb</span>
                <span
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-lg overflow-hidden">
              <div className="p-5 border-b border-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-white font-semibold">eCO2 Level</h2>
                </div>
              </div>
              <div
                className={`p-6 ${eco2Color} flex flex-col items-center justify-center h-48`}
              >
                <span className="text-4xl font-bold">{eco2Level}</span>
                <span className="text-lg mt-1">ppm</span>
                <span
                  className={`text-sm mt-3 px-3 py-1 rounded-full ${
                    eco2Level > 1000
                      ? "bg-rose-100 text-rose-800"
